    ...
    <div class="gallery-slider">
        <?php foreach ($gallery as $val) : ?>
            <div class="item">
                <?= _imgSrc($val, 'image') ?>
                <?php 
                if (isset($val['slug']) && !empty($val['slug'])) : ?>
                    <a href="<?= _isset($val, 'slug') ?>" class="btn btn-white linkBtn rounded-pill fw-800 px-4">
                    <span class="pe-2">See More</span> <svg width="16" height="11" viewBox="0 0 16 11" fill="none" xmlns="http://www.w3.org/2000/svg">
