            ...
            <div class="col-xl-9">
                <div class="d-flex flex-column h-100 justify-content-between">
                    <div class="row justify-content-between d-none d-md-flex">
                        <div class="col-auto">
                            <p class="fst-italic lh-1 fw-700">Emergency Plumbing</p>
                        ...
                        <div class="col-auto">
                            <p class="fst-italic lh-1 fw-700">Gas Plumbing</p>
                            <div class="services-menu pt-5">
                                <ul class="list-unstyled d-flex flex-column gap-2">
                    ...
                    <div class="row d-md-none gy-2">
                        <?php foreach ($services_menu_list as $index => $service) : ?>
                            <div class="col-12">
                                <a href="<?= _issetUrl($service, 'link') ?>" class="mobileServiceBtn <?= (count($services_menu_list) == $index + 1) ? 'bg-danger' : '' ?>">
                                    <div class="row justify-content-between align-items-center w-100 gx-2">
                                        <div class="col-2">
                                            <?= _imgSrc($service, 'icon') ?>
                                        </div>
                                        <div class="col">
                                            <?= _isset($service, 'title') ?>
                                        </div>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="row gx-0_5 gy-5 gy-lg-2 align-items-center justify-content-center justify-content-lg-between">
                            ...
                            <div class="col-12 col-lg-auto order-1 order-md-2">
                                <div class="social d-flex flex-row gap-4 justify-content-center align-items-center">
                                    <a href="<?= _isset($contact_info, 'facebook_link') ?>" target="_blank">
                                    ...
                                    <a href="<?= _isset($contact_info, 'instagram_link') ?>" target="_blank">
                                    ...
                                    <a href="<?= _isset($contact_info, 'youtube_link') ?>" target="_blank">
                                    ...
                                    <a href="<?= _isset($contact_info, 'linkedin_link') ?>" target="_blank">
