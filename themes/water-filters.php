...
<main class="waterFiltersServicePage">
    <section class="introduction">
        <div class="container-fluid px-0">
            <div class="row">
                <div class="col-6">
                    <img src="<?= V_CDN_URL . V_THEME_DIR ?>_assets/images/lib/water-filter.jpg" alt="Water Filter" />
                </div>
                <div class="col-6">
                    <article class="px-5 py-7 col-11 col-md-10 col-lg-9">
                        <h3 class="fs-64 text-capitalize highlight-primary lh-1 fw-400">For Those Who <span class="fw-700">Want Cleaner Water</span></h3>
                        <article class="description lh-1_5 pt-4">
                            <p>If you have worries about the quality of your water, a filter might be right for you! Ensuring that the water used for drinking and cooking is clean and free of any harmful contaminants is a concern everyone has. A water filter can provide peace of mind and protect our health by removing many impurities from tap water.</p>
                            <p>At Rapid Plumbing Group, we can help you look for the right water filter and get it installed. Whether it’s a simple faucet attachment or a whole house filtration system, we will meet your requirements. Don't hesitate to contact us for more information on how we can improve the quality of your drinking water.</p>
                        </article>
                    </article>
                </div>
            </div>
