        ...
        <div class="introduction pb-9">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <article>
                            <h2 class="fw-800 fs-64 lh-1 text-capitalize">Maintain hygiene in your plumbing system</h2>
                            <p class="fw-700 text-primary text-capitalize fs-20 pt-4">Stay on top of your septic system’s maintenance!</p>
                            <article class="fs-18 description pt-4 fw-300">
                                <p>Keeping a septic system in top working condition is crucial for both environmental and practical reasons. A septic system that isn’t maintained, with a full tank, is a significant health hazard, and also a cause of bad smells.
                                    Highly trained technicians from Rapid Plumbing Group can inspect and clean your septic tank, ensuring it stays effective and efficient.</p>

                                <p>This not only helps prevent backups and overflows, but it also benefits the surrounding land and waterways by properly disposing of wastewater. Don't risk the health of your family and the environment. Trust the experts at Rapid Plumbing Group for all of your septic needs.</p>
                            </article>
                    ...
                    <div class="col-md-6">
                        <img src="<?= V_CDN_URL . V_THEME_DIR ?>_assets/images/lib/septic-systems.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
